...
{* junk1.smcl}{...}
        {cmd}. type http://www.stata-press.com/data/r14/bcal_simple.raw
        {res}11/4/11 51
        11/7/11 9
        11/18/11 12
        11/21/11 4
...
{* edit for http://}{...}
{phang2}
        {cmd}. infile str10 sdate float x using http://www.stata-press.com/data/r14/bcal_simple{p_end}
