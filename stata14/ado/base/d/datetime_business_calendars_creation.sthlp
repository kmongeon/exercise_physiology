...
{cmd:14.2}, future versions of Stata will know how to interpret the file even
if the definition of the stbcal-file language has greatly changed.
...
{cmd:version} {it:version_of_stata}{break}
    At the time of this writing, you would specify {cmd:version} {cmd:14.2}.
    ...
    look at the documentation so that you use the modern syntax
    correctly.
...
these directories happen to be
            ...
            {cmd}. sysdir
               {txt}STATA:  {res}C:\Program Files\Stata14\
                {txt}BASE:  {res}C:\Program Files\Stata14\ado\base\
                {txt}SITE:  {res}C:\Program Files\Stata14\ado\site\
