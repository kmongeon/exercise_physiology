...
{viewerjumpto "Syntax" "dta_115##syntax"}{...}
{viewerjumpto "Remarks" "dta_115##remarks"}{...}
{title:Title}

{p2colset 5 30 32 2}{...}
{p2col :{hi:[P] file formats .dta} {hline 2}}Description of .dta file format 115{p_end}
{p2colreset}{...}
...
Remarks are presented under the following headings:
	...
	{help dta_115##intro:1.  Introduction}
	{help dta_115##versions:2.  Versions and flavors of Stata}
	{help dta_115##strings:3.  Representation of strings}
	{help dta_115##numbers:4   Representation of numbers}
 	{help dta_115##definition:5.  Dataset format definition}
	    {help dta_115##header:5.1  Header}
	    {help dta_115##descriptors:5.2  Descriptors}
	    {help dta_115##variable_labels:5.3  Variable labels}
	    {help dta_115##expansion_fields:5.4  Expansion fields}
	    {help dta_115##data:5.5  Data}
	    {help dta_115##value_labels:5.6  Value labels}
...
what are known as {hi:format-115} datasets.  Stata
