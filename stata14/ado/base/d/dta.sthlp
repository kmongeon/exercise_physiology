...
{pstd}
The format described here went into effect as of Stata 14. 
For documentation on earlier file formats, see {help dta_117}. 
...
what are known as {it:format-118} datasets, the most modern format.  Stata
...
a dataset written on 10 March 2015 at 2:23 p.m. would look like this:
	...
	<stata_dta>
		...
		<timestamp>{rm:{it:11}}10 Mar 2015 14:23</timestamp>
	    </header>
...
actually run together, so it looks more like this,
	...
	teorder><K>{rm:{it:0002}}</K><N>{red:{rm:{it:0000000000000001}}}</N><label>{red:{rm:{it:000b}}}Sample 
	 Data</label><timestamp>{rm:{it:11}}10 Mar 2015 14:23</timestamp></he
...
length of the datestamp that follows it: "10 Mar 2015 14:23".
