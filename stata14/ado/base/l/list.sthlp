...
{mansection I Glossarydisambig:display columns};
default is {cmd:ab(8)}{p_end}
{synopt :{opt str:ing(#)}}truncate string variables to {it:#} 
{mansection I Glossarydisambig:display columns}{p_end}
...
truncated to {it:#}
{mansection I Glossarydisambig:display columns} in the
