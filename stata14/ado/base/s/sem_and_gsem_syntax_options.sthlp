...
{p2colset 5 42 44 2}{...}
{p2col:{manlink SEM sem and gsem syntax options} {hline 2}}Options affecting
...
{cmd:sem} and {cmd:gsem} ordinarily assumes that latent variables
