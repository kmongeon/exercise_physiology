...
{cmd:stcox}, {cmd:streg}, {cmd:mestreg}, and {cmd:xtstreg}.
...
when used after {cmd:stcox}, {cmd:streg}, {cmd:mestreg}, or {cmd:xtstreg}
and requests that the cumulative subhazard function be plotted when used
after {cmd:stcrreg}.
...
and for random-effects models.  This option is not allowed after {opt xtstreg}.
