...
{p 4 15 2}Or {space 4} 1) Select {bf:Help > SJ and user-written commands}{p_end}
...
StataCorp; see
{browse "http://www.stata.com/bookstore/subscribe-stata-journal/"}.
{p_end}
