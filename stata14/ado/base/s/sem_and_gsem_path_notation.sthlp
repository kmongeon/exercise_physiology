...
{p2colset 5 41 43 2}{...}
{p2col:{manlink SEM sem and gsem path notation} {hline 2}}Command syntax for
path diagrams{p_end}
{p2colreset}{...}
...
response variables and for specification of multilevel latent variables.
