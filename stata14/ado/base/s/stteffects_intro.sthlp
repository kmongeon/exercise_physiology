...
{p2colset 5 30 32 2}{...}
{p2col :{manlink TE stteffects intro} {hline 2}}Introduction to treatment
...
is the treatment; and we model the time to censoring as a function of
{cmd:age}, {cmd:exercise}, and {cmd:diet}.

{phang2}{cmd:. stteffects ipw (age exercise diet education)}
        {cmd:(smoke) (age exercise diet education)}
