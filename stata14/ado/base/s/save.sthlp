...
{synoptline}
{synopt :{opt v:ersion(#)}}specify version 11<={it:#}<=13; default is {cmd:version(13)}, meaning Stata 13 format{p_end}
{synopt :{opt nol:abel}}omit value labels from the saved dataset{p_end}
{synopt :{opt replace}}overwrite existing dataset{p_end}
{synopt :{opt all}}save {cmd:e(sample)} with the dataset; programmer's
option{p_end}
...
or 11.  If you are using Stata 14 and want to save a file so that it may be
