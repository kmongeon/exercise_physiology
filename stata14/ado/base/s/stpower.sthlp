...
{pstd}
See {manhelp power PSS} for a recommended alternative to {cmd:stpower}, and
in particular, see {manhelp power_cox PSS:power cox},
{manhelp power_logrank PSS:power logrank}, and
{manhelp power_exponential PSS:power exponential}.
...
{pstd}
Also see {manhelp power PSS} for power and sample-size analysis for other
statistical methods.
