...
{p2colset 5 50 52 2}{...}
{p2col:{manlink SEM sem and gsem option covstructure()} {hline 2}}Specifying covariance
restrictions{p_end}
{p2colreset}{...}
...
{p 8 12 2}
{cmd:sem} ... [{cmd:,} ...
         {cmdab:covstr:ucture(}{it:{help sem and gsem option covstructure##groupid:groupid}}{cmd::} {it:{help sem and gsem option covstructure##variables:variables}}{cmd:,}
	       {it:{help sem and gsem option covstructure##structure:structure}}{cmd:)} ...]
...
{marker groupid}{...}
{pstd}
{it:groupid} may be specified only when the {opt group()} option is also
...
{pstd}
See {helpb sem_and gsem path_notation##item11:[SEM] sem and gsem path notation}.
...
{phang}
{cmd:covstruct(}[{it:groupid}{cmd::}] {it:variables}{cmd:,} {it:structure}{cmd:)} is
...
error variables of your model.  Optional {it:groupid} is available only
with {cmd:sem} with option {cmd:group()} specified; see
{helpb sem_group_options:[SEM] sem group options}.
