...
{p2colset 5 48 50 2}{...}
{p2col:{manlink SEM sem and gsem option constraints()} {hline 2}}Specifying constraints{p_end}
{p2colreset}{...}
...
{phang2}{cmd:. constraint 1 _b[y_logs:_cons] = 0}{p_end}
