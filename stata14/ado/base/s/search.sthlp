...
{p2colset 5 19 21 2}{...}
{p2col:{manlink R search} {hline 2}}Search Stata documentation and other resources{p_end}
{p2colreset}{...}
...
including user-written additions.  From the results, you can click to go to a
