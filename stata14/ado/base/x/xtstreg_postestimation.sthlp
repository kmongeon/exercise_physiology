...
{p2colset 5 36 38 2}{...}
{p2col :{manlink XT xtstreg postestimation} {hline 2}}Postestimation tools for xtstreg{p_end}
{p2colreset}{...}
...
{phang2}{cmd:. predict mean, mean}
{phang2}{cmd:. predict mean0, mean0}
