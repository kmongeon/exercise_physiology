...
{p2colset 5 38 40 2}{...}
{p2col :{manlink XT xtoprobit postestimation} {hline 2}}Postestimation tools for xtoprobit{p_end}
{p2colreset}{...}
...
{pstd}
The following postestimation commands are available after {cmd:xtoprobit}:
...
{synopt:{helpb xtoprobit_postestimation##margins:margins}}marginal
	means, predictive margins, marginal effects, and average marginal
	effects{p_end}
INCLUDE help post_marginsplot
INCLUDE help post_nlcom
{synopt :{helpb xtoprobit postestimation##predict:predict}}predictions, residuals, influence statistics, and other diagnostic measures{p_end}
...
{cmd:xtoprobit}.  This option modifies the calculations made by {cmd:predict} so
