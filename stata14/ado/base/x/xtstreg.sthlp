...
{p2colset 5 21 23 2}{...}
{p2col :{manlink XT xtstreg} {hline 2}}Random-effects parametric survival models{p_end}
{p2colreset}{...}
...
{p 8 18 2}
{cmd:xtstreg} [{varlist}] {ifin} {weight}{cmd:,}
	{opth d:istribution(xtstreg##distname:distname)}
        [{it:options}]
...
{p2coldent :* {cmdab:d:istribution(}{it:{help xtstreg##distname:distname}}{cmd:)}}specify survival distribution{p_end}
...
{phang}
{bf:Statistics > Longitudinal/panel data > Parametric survival regression}
...
{pstd}
The following option is available with {opt xtstreg} but is not shown in the
dialog box:
