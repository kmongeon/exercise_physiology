...
realization is an ARMA process plus a linear function of a set of
...
as well as dynamic forecasts, but static forecasts cannot produce forecasts
...
in the dataset, static forecasts can only forecast one period into the future
(assuming only first lags appear in the model); for that reason, they are
