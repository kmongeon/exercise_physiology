...
{p2colset 5 30 32 2}{...}
{p2col :{manlink TE teffects psmatch} {hline 2}}Propensity-score
matching{p_end}
...
{synopt :{opt pstol:erance(#)}}set tolerance for in overlap assumption{p_end}
...
differentiable.  The implemented method
were derived by
