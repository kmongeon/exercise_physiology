...
{p2colset 5 18 20 2}{...}
{p2col:{manlink R ttest} {hline 2}}t tests (mean-comparison tests){p_end}
{p2colreset}{...}
...
{phang}
{browse "http://www.youtube.com/watch?v=BfLw-AhXH-8":Immediate commands in Stata: One-sample t test from summary data}

{phang}
{browse "http://www.youtube.com/watch?v=6cQwbvvkFO8":Immediate commands in Stata: Two-sample t test from summary data}
