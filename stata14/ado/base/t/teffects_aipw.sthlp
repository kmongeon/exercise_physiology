...
{p2colset 5 27 29 2}{...}
{p2col :{manlink TE teffects aipw} {hline 2}}Augmented inverse-probability
weighting{p_end}
{p2colreset}{...}
...
{synopt :{opth os:ample(varname)}}{it:newvar} identifies observations that
