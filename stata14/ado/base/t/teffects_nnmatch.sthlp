...
{p2colset 5 30 32 2}{...}
{p2col :{manlink TE teffects nnmatch} {hline 2}}Nearest-neighbor
matching{p_end}
...
{p2col 5 31 33 2:}{cmd:vce(iid)}; use default Abadie-Imbens standard
      errors{p_end}
...
By default, {cmd:teffects} {cmd:nnmatch} uses two matches in estimating the
...
{opt nneighbors(#)} because of tied distances.  These variables may not
already exist.
