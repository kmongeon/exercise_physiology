...
{p2colset 5 30 32 2}{...}
{p2col :{manlink TE teffects overlap} {hline 2}}Overlap plots{p_end}
{p2colreset}{...}
...
{synoptline}
{syntab :Main}
{synopt: {opt ptl:evel(treat_level)}}calculate predicted probabilities for
