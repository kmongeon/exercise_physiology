...
{p2colset 5 28 30 2}{...}
{p2col:{manlink R tabulate twoway} {hline 2}}Two-way table of frequencies{p_end}
{p2colreset}{...}
...
{phang}
{browse "http://www.youtube.com/watch?v=GZIi9zAlzIA":Immediate commands in Stata: Cross-tabulations and chi-squared tests from summary data}
