...
{p2colset 5 31 33 2}{...}
{p2col :{manlink TE tebalance density} {hline 2}}Covariate balance density{p_end}
...
{synopt :{it:{help twoway_options}}}any options other than {cmd:by()} documented in {manhelpi twoway_options G-3}{p_end}
