...
{p2colset 5 35 37 2}{...}
{p2col :{manlink R churdle postestimation} {hline 2}}Postestimation tools for churdle{p_end}
{p2colreset}{...}
...
{cmd:predict}
{dtype}
{{it:stub}{cmd:*}|{it:{help newvarlist:newvarlist}}}
...
{synopt :{cmdab:p:r(}{it:a}{cmd:,}{it:b}{cmd:)}}Pr({it:a} < y < {it:b}){p_end}
...
{synopt :{cmdab:p:r(}{it:a}{cmd:,}{it:b}{cmd:)}}Pr({it:a} < y < {it:b}); for {cmd:churdle exponential} {it:b} is .{p_end}
