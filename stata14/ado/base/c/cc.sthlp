...
{p2colset 5 19 21 2}{...}
{p2col :{manlink R epitab} {hline 2}}Tables for epidemiologists (cc and cci)
{p_end}
{p2colreset}{...}
...
{phang}
{browse "http://www.youtube.com/watch?v=A1c4ElvFHIE":Immediate commands in Stata: Computing odds ratios from summary data}
