...
{p2colset 5 20 22 2}{...}
{p2col :{manlink R churdle} {hline 2}}Cragg hurdle regression{p_end}
{p2colreset}{...}
...
{p 10 10 2}
{cmdab:sel:ect(}{it:varlist_s}[{cmd:,} {cmdab:nocon:stant} {opt het(varlist_o)}]{cmd:)}{p_end}
...
{pstd}Cragg hurdle linear regression with survey data{p_end}
{phang2}{cmd:. svy: churdle linear finalwgt i.female copper, ll(2000) select(highbp agegrp)}
