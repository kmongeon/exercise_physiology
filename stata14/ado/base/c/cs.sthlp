...
{p2colset 5 19 21 2}{...}
{p2col :{manlink R epitab} {hline 2}}Tables for epidemiologists (cs and csi)
{p_end}
{p2colreset}{...}
...
{phang}
{browse "http://www.youtube.com/watch?v=ZYaYUpgahv4":Immediate commands in Stata: Computing risk ratios from summary data}
