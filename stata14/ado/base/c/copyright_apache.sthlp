{smcl}
{* *! version 1.0.0  20apr2013}{...}
{vieweralsosee "[R] copyright apache" "mansection R copyrightapache"}{...}
{vieweralsosee "" "--"}{...}
{vieweralsosee "[R] copyright" "help copyright"}{...}
{title:Title}

{p2colset 5 29 31 2}{...}
{p2col :{manlink R copyright apache} {hline 2}}Apache copyright notification{p_end}
{p2colreset}{...}
...
{p 4 4 2}
Stata uses portions of the Apache Commons Java components library, Apache log4j
Java library, and the docx4j Java library with the express permission of
the authors under the Apache License, version 2.0, pursuant to the following
notice:
