...
{p 4 8 4}
{bf:{help file:file - Read and write text and binary files}}

{p 4 8 4}
{bf:{help filefilter:filefilter - Convert ASCII or binary patterns in a file}}
...
{p 4 8 4}
{bf:{help set_locale_functions:set locale_functions - Specify default locale for functions}}

{p 4 8 4}
{bf:{help set_locale_ui:set locale_ui - Specify a localization package for the user interface}}

{p 4 8 4}
{bf:{help set_rng:set rng - Set which random-number generator (RNG) to use}}

{p 4 8 4}
{bf:{help set_seed:set seed - Specify random-number seed and state}}
...
{p 4 8 4}
{bf:{help unicode_collator:unicode collator - Language-specific Unicode collators}}

{p 4 8 4}
{bf:{help unicode_convertfile:unicode convertfile - Low-level file conversion between encodings}}

{p 4 8 4}
{bf:{help unicode_encoding:unicode encoding - Unicode encoding utilities}}
