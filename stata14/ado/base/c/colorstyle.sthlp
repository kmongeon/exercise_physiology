...
128 in all the examples above would keep the colors the same but make them
dimmer.  (Color {cmd:128} {cmd:128} {cmd:128} is what most people call gray.)
...
With the exception of {cmd:black}, all the listed colors specify a
