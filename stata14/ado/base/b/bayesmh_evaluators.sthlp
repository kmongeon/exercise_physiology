...
{p2colset 5 35 37 2}{...}
{p2col :{manlink BAYES bayesmh evaluators} {hline 2}}User-defined evaluators with bayesmh{p_end}
{p2colreset}{...}
...
be specified for all model parameters and can be repeated.{p_end}
