...
{cmd:bcal} {cmd:dir} reports on business calendars available:
        ...
        {res}{txt}  1 calendar file found:
          simple:  C:\Program Files\Stata14\ado\base\s\simple.stbcal
...
The business calendar file created: 
	...
	* Created/replaced on 20 Aug 2016
...
except it does not store {cmd:r(omitted)} and {cmd:r(included)}.
{p_end}
