...
{p2colset 5 20 22 2}{...}
{p2col :{manlink R betareg} {hline 2}}Beta regression{p_end}
{p2colreset}{...}
...
{synopt :{cmdab:sca:le(}{varlist} [{cmd:,} {cmdab:nocon:stant}{cmd:)}}specify
...
{syntab:SE/Robust}
{synopt :{opth vcetype(vcetype)}}{it:vcetype} may be {opt oim},
...
{synopt:{cmd:e(link)}}link function in the conditional mean equation{p_end}
{synopt:{cmd:e(slink)}}link function in the conditional scale equation{p_end}
