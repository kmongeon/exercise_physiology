...
imply all elements of this matrix. See {it:{mansection BAYES bayesmhpostestimationRemarksandexamplesDifferentwaysofspecifyingmodelparameters:Different ways of specifying model parameters}} in {bf:[BAYES] bayesmh postestimation}
for examples.
{p_end}
