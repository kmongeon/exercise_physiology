...
{synopt :{opt nocon:stant}}the model has no constant term; seldom used{p_end}
...
{p 12 18 2}{cmd:version 14.2}{p_end}
...
{p 16 22 2}{cmd:version 14.2}{p_end}
