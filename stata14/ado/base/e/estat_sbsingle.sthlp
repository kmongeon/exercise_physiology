...
{p2colset 5 28 30 2}{...}
{p2col:{manlink TS estat sbsingle} {hline 2}}Test for a structural break with
...
{synopt:{cmd:(chi2)}}chi-squared test statistic{p_end}
{synopt:{cmd:(p)}}level of significance{p_end}
{synopt:{cmd:(df)}}degrees of freedom{p_end}
