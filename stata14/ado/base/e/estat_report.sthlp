...
{p2colset 5 27 29 2}{...}
{p2col:{manlink IRT estat report} {hline 2}}Report estimated IRT parameters{p_end}
{p2colreset}{...}
...
{phang}
{cmd:sort(}{it:p}[{cmd:,} {cmd:descending}{cmd:)}
...
pseudoguessing parameters.  It is only relevant for a 3PL model
