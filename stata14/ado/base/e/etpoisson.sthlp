...
{p2colset 5 23 25 2}{...}
{p2col :{manlink TE etpoisson} {hline 2}}Poisson regression with endogenous
...
{phang}
{cmd:treat(}{depvar:_t} {cmd:=} {indepvars:_t}[{cmd:,} {opt nocon:stant}
...
{pstd}
The following option is available with {opt etpoisson} but is not shown in the
dialog box:
...
{synopt:{cmd:e(p_c)}}significance of comparison test{p_end}
