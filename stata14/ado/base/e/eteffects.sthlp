...
{p2colset 5 23 25 2}{...}
{p2col :{manlink TE eteffects} {hline 2}}Endogenous treatment-effects
estimation{p_end}
{p2colreset}{...}
...
{p 8 16 2}
{cmd:eteffects} ({help varlist:{it:ovar}}
{help varlist:{it:omvarlist}}
[{cmd:,} {help eteffects##omodel:{it:omodel}}
        {opt nocon:stant}])
        ({help varlist:{it:tvar}} {help varlist:{it:tmvarlist}}
        [{cmd:,} {opt nocon:stant}])
        {ifin} 
...
{bf:Statistics > Treatment effects > Continuous outcomes >}
    {bf:Endogenous treatment, control function} 
