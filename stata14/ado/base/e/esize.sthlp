...
{p2colset 5 18 20 2}{...}
{p2col:{manlink R esize} {hline 2}}Effect size based on mean comparison{p_end}
{p2colreset}{...}
...
{phang}
{browse "http://www.youtube.com/watch?v=rfn5FY96BMc&feature=youtu.be":Tour of effect sizes}
...
{synopt:{cmd:r(lb_omega2)}}lower confidence bound for omega-squared{p_end}
{synopt:{cmd:r(ub_omega2)}}upper confidence bound for omega-squared{p_end}
{synopt:{cmd:r(level)}}confidence level{p_end}
{p2colreset}{...}
