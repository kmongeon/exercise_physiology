...
{it:mname} {cmd::} {it:extended_function}
...
{pstd}Macro extended functions for names of stored results
...
into {it:mname} should be returned.  {cmd:nofail} should rarely, if
ever, be specified.
