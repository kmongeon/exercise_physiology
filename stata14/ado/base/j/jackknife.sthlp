...
commands, functions of coefficients, or user-written programs.  To jackknife
coefficients, we recommend using the {cmd:vce(jackknife)} option when allowed
by the estimation command. 
