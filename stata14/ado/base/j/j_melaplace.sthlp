...
integrand.  In {helpb meqrlogit} and {helpb meqrpoisson}, the Laplacian
approximation is equivalent to mode-curvature adaptive Gauss-Hermite
quadrature with one integration point as described in
{help j_melaplace##PB1995:Pinheiro and Bates (1995)}.
In other generalized linear mixed-effects commands, the Laplacian
approximation is equivalent to the mode-curvature adaptive Gauss-Hermite
quadrature with one integration point as described in
{help j_melaplace##SRH2004:Skrondal and Rabe-Hesketh (2004)}.
In both cases, the Laplacian approximation is quadrature performed using
