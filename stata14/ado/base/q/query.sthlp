...
{center:{cmd:set prefix}                   {help set prefix}          }
...
{pstd}
{cmd:query unicode} displays settings related to Unicode.

{pstd}
{cmd:query other} displays other system parameters.

{pstd}
{cmd:query} without argument displays all of these sets of parameters.
