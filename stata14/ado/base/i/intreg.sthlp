...
{pstd}
{cmd:intreg} fits a model in which the dependent variable may be measured as
point data, interval data, left-censored data, or right-censored data.  As
such, it is a generalization of the models fit by {helpb tobit}.  The
dependent variable must be specified using two {depvar}s that indicate how it
was measured.
