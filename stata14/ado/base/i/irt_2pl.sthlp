...
{p2colset 5 22 24 2}{...}
{p2col :{manlink IRT irt 2pl} {hline 2}}Two-parameter logistic model{p_end}
{p2colreset}{...}
...
{synopt :{help irt_2pl##display_options:{it:display_options}}}control
INCLUDE help opt_irt_display

{syntab:Integration}
{synopt :{cmdab:intm:ethod(}{help irt_2pl##intmethod:{it:intmethod}}{cmd:)}}integration method{p_end}
INCLUDE help opt_irt_int

{syntab:Maximization}
{synopt :{it:{help irt_2pl##maximize_options:maximize_options}}}control the maximization process; seldom used{p_end}

{synopt :{cmdab:startv:alues(}{it:{help irt_2pl##startvalues:svmethod}}{cmd:)}}method for obtaining starting values{p_end}
...
{p 4 6 2}
See {manhelp irt_2pl_postestimation IRT:irt 2pl postestimation} for features
...
{pstd}
{cmd:irt 2pl} fits two-parameter logistic (2PL) models to binary items.  In
the 2PL model, items vary in their difficulty and discrimination.
...
{pstd}
{cmd:irt 2pl} stores the following in {cmd:e()}:
