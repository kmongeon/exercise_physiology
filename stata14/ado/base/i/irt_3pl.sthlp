...
{p2colset 5 22 24 2}{...}
{p2col :{manlink IRT irt 3pl} {hline 2}}Three-parameter logistic model{p_end}
{p2colreset}{...}
...
{synopt :{opt sepg:uessing}}estimate a separate pseudoguessing parameter for each item{p_end}
...
{synopt :{help irt_3pl##display_options:{it:display_options}}}control
INCLUDE help opt_irt_display

{syntab:Integration}
{synopt :{cmdab:intm:ethod(}{help irt_3pl##intmethod:{it:intmethod}}{cmd:)}}integration method{p_end}
INCLUDE help opt_irt_int

{syntab:Maximization}
{synopt :{it:{help irt_3pl##maximize_options:maximize_options}}}control the maximization process; seldom used{p_end}

{synopt :{cmdab:startv:alues(}{it:{help irt_3pl##startvalues:svmethod}}{cmd:)}}method for obtaining starting values{p_end}
...
{p 4 6 2}
See {manhelp irt_3pl_postestimation IRT:irt 3pl postestimation} for features
...
{pstd}
{cmd:irt 3pl} fits three-parameter logistic (3PL) models to binary items.
In the 3PL model, items vary in their difficulty and discrimination
and the possibility of guessing is allowed.
...
estimated for each item.  This is a seldom used option; see the
{mansection IRT irt3plRemarksandexamplessepguess:technical note} in
{bf:[IRT] irt 3pl}.
...
{pstd}
{cmd:irt 3pl} stores the following in {cmd:e()}:
