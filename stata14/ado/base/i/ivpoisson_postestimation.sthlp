...
{vieweralsosee "[R] ivpoisson postestimation" "mansection R ivpoisson postestimation"}{...}
{vieweralsosee "" "--"}{...}
...
{p2colset 5 37 30 2}{...}
{p2col :{manlink R  ivpoisson postestimation} {hline 2}}Postestimation tools for ivpoisson{p_end}
{p2colreset}{...}
