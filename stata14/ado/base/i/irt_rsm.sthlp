...
{p2colset 5 22 24 2}{...}
{p2col :{manlink IRT irt rsm} {hline 2}}Rating scale model{p_end}
{p2colreset}{...}
...
{synopt :{help irt_rsm##display_options:{it:display_options}}}control
INCLUDE help opt_irt_display

{syntab:Integration}
{synopt :{cmdab:intm:ethod(}{help irt_rsm##intmethod:{it:intmethod}}{cmd:)}}integration method{p_end}
INCLUDE help opt_irt_int

{syntab:Maximization}
{synopt :{it:{help irt_rsm##maximize_options:maximize_options}}}control the maximization process; seldom used{p_end}

{synopt :{cmdab:startv:alues(}{it:{help irt_rsm##startvalues:svmethod}}{cmd:)}}method for obtaining starting values{p_end}
...
{p 4 6 2}
See {manhelp irt_rsm_postestimation IRT:irt rsm postestimation} for features
...
{pstd}
{cmd:irt rsm} fits rating scale models to ordinal items.  In the rating scale
model, items vary in their difficulty but share the same discrimination
parameter.  The distance between the difficulties of adjacent outcomes are
constrained to be equal across the items.
...
{pstd}
{cmd:irt rsm} stores the following in {cmd:e()}:
