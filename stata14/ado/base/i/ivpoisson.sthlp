...
{p2colset 5 22 23 2}{...}
{p2col :{manlink R ivpoisson} {hline 2}}Poisson model with continuous endogenous
covariates{p_end}
{p2colreset}{...}
...
{bf:Statistics > Endogenous covariates >}
      {bf:Poisson model with continuous endogenous covariates}
...
initialize {opt male} to 1.23 and the constant {opt _cons} to 4.57, you would
type
