{smcl}
{* *! version 1.0.19  02sep2016}{...}
{viewerdialog "import delimited" "dialog import_delimited_dlg"}{...}
{vieweralsosee "[D] import delimited" "mansection D import delimited"}{...}
{vieweralsosee "" "--"}{...}
...
{p2colset 5 29 30 2}{...}
{p2col :{manlink D import delimited} {hline 2}}Import delimited text data{p_end}
{p2colreset}{...}
...
{synopt :{cmd:case(preserve}|{cmd:lower}|{cmd:upper)}}preserve the case
         or read variable names as lowercase (the default) or uppercase{p_end}
...
can be found at
{browse "http://docs.oracle.com/javase/8/docs/technotes/guides/intl/encoding.doc.html"}.
...
Setup{p_end}
{phang2}
{cmd:. copy http://www.stata.com/examples/auto.csv auto.csv}
...
{phang}
{browse "http://www.youtube.com/watch?v=60RBNsqzL6I&feature=youtu.be":Importing delimited data}
{p_end}
