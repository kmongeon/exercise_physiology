...
{viewerjumpto "Postestimation commands" "irt grm postestimation##description"}{...}
{viewerjumpto "predict" "irt grm postestimation##syntax_predict"}{...}
{viewerjumpto "Examples" "irt grm postestimation##examples"}{...}
{title:Title}

{p2colset 5 37 39 2}{...}
{p2col :{manlink IRT irt grm postestimation} {hline 2}}Postestimation tools for 
irt grm {p_end}
{p2colreset}{...}
...
{synopt :{helpb irt grm postestimation##predict:predict}}predictions{p_end}
...
[{cmd:,} {it:{help irt_grm_postestimation##statistic:statistic}}
...
{syntab:Integration}
{synopt :{help irt_grm_postestimation##int_options:{it:int_options}}}integration
    options{p_end}
{synoptline}
{p2colreset}{...}
