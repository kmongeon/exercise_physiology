...
{opt var}, {opt svar}, {opt vec}, {opt arima}, or {opt arfima}; see
{helpb var:[TS] var}, {helpb svar:[TS] var svar}, {helpb vec:[TS] vec},
{helpb arima:[TS] arima}, or {helpb arfima:[TS] arfima}.
...
{pstd}
{opt irf} creates and manipulates IRF files that contain estimates of the
IRFs created after estimation by {helpb arima} or {helpb arfima}.
