...
{p2colset 5 19 21 2}{...}
{p2col :{manlink R epitab} {hline 2}}Tables for epidemiologists (ir and iri)
{p_end}
{p2colreset}{...}
...
{phang}
{browse "http://www.youtube.com/watch?v=6JANRVFxqAw":Immediate commands in Stata: Computing incidence-rate ratios from summary data}
