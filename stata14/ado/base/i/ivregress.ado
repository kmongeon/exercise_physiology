...
{
	real matrix dep, endog, exog, wt, data, dataorig
	real matrix ZPZ, ZPZi, Z1PZ1, Z1PZ1i, ZPY, Z1PY, YPY
	real matrix YPMZY, YPMZYsqi, YPM1Y, eigenvals
	real matrix ZPX, XPY, XPX, ALL
	real matrix var, beta, err
	
	real scalar kappa, rss, capn, i1, i2, j2
	if(hasfv) {
		st_view(dataorig=., ., 
