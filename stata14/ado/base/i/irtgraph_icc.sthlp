...
{p2colset 5 27 29 2}{...}
{p2col :{manlink IRT irtgraph icc} {hline 2}}Item characteristic curve plot{p_end}
{p2colreset}{...}
...
{phang}
{it:varlist} is a list of items from the currently fitted IRT model.
