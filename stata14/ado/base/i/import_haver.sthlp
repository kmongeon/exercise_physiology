...
{p2colset 5 25 22 2}{...}
{p2col :{manlink D import haver} {hline 2}}Import data from Haver Analytics
databases{p_end}
{p2colreset}{...}
...
HAVERMQA.
	...
	{cmd:. copy http://www.stata.com/haver/HAVERD.DAT haverd.dat}
	{cmd:. copy http://www.stata.com/haver/HAVERD.IDX haverd.idx}
	{cmd:. copy http://www.stata.com/haver/HAVERW.DAT haverw.dat}
	{cmd:. copy http://www.stata.com/haver/HAVERW.IDX haverw.idx}
	{cmd:. copy http://www.stata.com/haver/HAVERMQA.DAT havermqa.dat}
	{cmd:. copy http://www.stata.com/haver/HAVERMQA.IDX havermqa.idx}
