...
{p2colset 5 20 22 2}{...}
{p2col :{manlink R ivtobit} {hline 2}}Tobit model with continuous endogenous
covariates{p_end}
{p2colreset}{...}
...
{synoptline}
{syntab :Model}
{p2coldent :* {cmd:ll}[{cmd:(}{it:#}{cmd:)}]}lower limit for left-censoring{p_end}
{p2coldent :* {cmd:ul}[{cmd:(}{it:#}{cmd:)}]}upper limit for right-censoring{p_end}
...
{p2coldent :* {opt ll}[{cmd:(}{it:#}{cmd:)}]}lower limit for left-censoring{p_end}
{p2coldent :* {opt ul}[{cmd:(}{it:#}{cmd:)}]}upper limit for right-censoring{p_end}
...
{phang}
{bf:Statistics > Endogenous covariates > Tobit model with continuous endogenous covariates}
