...
{pmore2}
    See the all-new
    {mansection TE te:{it:Stata Treatment-Effects Reference Manual}},
...
{pmore2}
    ...
    See {mansection PSS pss:{it:Stata Power and Sample-Size Reference Manual}};
    start by seeing {manlink PSS intro}.
