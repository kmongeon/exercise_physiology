...
{cmd:http://www.stata-press.com/data/r14/}.
...
to {cmd:http://www.stata-press.com/data/r14/}.
...
http://www.stata-press.com/data/r14{p_end}
{phang2}{cmd:. webuse lifeexp}

{pstd}Equivalent to above command{p_end}
{phang2}{cmd:. use http://www.stata-press.com/data/r14/lifeexp}{p_end}
