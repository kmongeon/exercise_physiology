...
13.1 releases:
    ...
    {c LT}{hline 63}{c RT}
    {c |} {help whatsnew}         Stata 14.0, 14.1, and 14.2   2015 to present {c |}
...
23.  {helpb power} did not allow the specification of two-sample
     ...
     {help power_userwritten:help power userwritten} for more details.
...
{p 5 9 2}
6.  {helpb mixed_postestimation##estatcov:estat recovariance} after
...
{p 5 9 2}
7.  {helpb mixed_postestimation##estatwcor:estat wcorrelation} after
...
3.  {helpb power} now provides facilities for users to add their own methods
    to {cmd:power}.  See {helpb power userwritten} for details.
