...
{p2colset 5 26 28 2}{...}
{p2col :{manlink P window manage} {hline 2}}Manage window characteristics{p_end}
{p2colreset}{...}
...
{pstd}
Under Stata for Mac and Stata for Unix, specifying the Command, Results,
Review, or Variables windows will bring the main Stata window forward because
these windows are all contained within one window.  {p_end}
