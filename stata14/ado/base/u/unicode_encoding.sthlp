...
{p2colset 5 29 31 2}{...}
{p2col :{manlink D unicode encoding} {hline 2}}Unicode encoding utilities{p_end}
{p2colreset}{...}
...
Microsoft Windows and Mac OS X.  For more information about encodings,
...
with Stata 14.  See {manhelp unicode_translate D:unicode translate}
...
for use in Stata 14.  If we are working on a Windows machine, the
most likely encoding is Windows-1252.  If we want to check that this is
how it should be specified as we use {cmd:unicode translate}, we can
type
