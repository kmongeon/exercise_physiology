...
{phang}{cmd:. describe using http://www.stata-press.com/data/r14/autocost}
{p_end}
{phang}{cmd:. merge 1:1 make using http://www.stata-press.com/data/r14/autocost}

{phang}{cmd:. webuse kahn, clear}{p_end}
{phang}{cmd:. istdize death pop age using}
                {cmd:http://www.stata-press.com/data/r14/popkahn,}
