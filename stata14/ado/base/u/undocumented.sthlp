...
{p2col:Power and}{p_end}
{p2col 7 34 36 2:Sample Size ([PSS])}Description{p_end}
{p2line}
{p2col:{manhelp power_userwritten PSS:power userwritten}}add your own methods to the {cmd:power} command{p_end}
{p2line}
...
{p2col:{manhelp set_prefix P:set prefix}}add a prefix name to {cmd:c(prefix)}{p_end}
