...
{mansection I Glossaryplainascii:plain ASCII} {it:chars} be substituted for
...
{synopt:{cmd:_dta[ReS_Xij_wide}{it:#}{cmd:]}}names of {it:#}th set of {cmd:X_ij} variables in wide form{p_end}
