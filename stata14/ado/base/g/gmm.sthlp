...
{cmd:{c -(}xb:} {cmd:mpg} {cmd:price} {cmd:turn} {cmd:_cons}{c )-}} defines a
...
{pmore}{space 4}{cmd:version 14.2}{p_end}
...
could have used Stata's {help extended_fcn:extended macro} functions to obtain
it from the {cmd:`at'} vector as well.
