...
{p2colset 5 20 22 2}{...}
{p2col :{manlink R fracreg} {hline 2}}Fractional response regression{p_end}
{p2colreset}{...}
...
{p 4 6 2}
{cmd:bootstrap}, {cmd:by}, {opt fp}, {cmd:jackknife}, {cmd:mi estimate},
{cmd:rolling}, {cmd:statsby}, and {cmd:svy} are allowed; see 
{help prefix}.{p_end}
INCLUDE help vce_mi
...
variables and the offset variable, if there is one, in the variance
function.  {cmd:het()} may only be used with {cmd:fracreg probit} to
compute fractional heteroskedastic probit regression.
