...
{p2colset 5 35 37 2}{...}
{p2col :{manlink R fracreg postestimation} {hline 2}}Postestimation tools for fracreg{p_end}
{p2colreset}{...}
...
{p 8 19 2}
{cmd:predict} {dtype}
{c -(}{it:stub}{cmd:*} {c |} {it:{help newvar}} {c |} {it:{help newvarlist}}{c )-}
