...
{p2col:}{cmd:regexm()} is intended for use with only
	{mansection I Glossaryplainascii:plain ASCII} characters.  For
	Unicode characters beyond the plain ASCII range, the match
	is based on {mansection I Glossarydisambig:bytes}.  For a
...
{p2col:}{cmd:regexr()} is intended for use with only
	{mansection I Glossaryplainascii:plain ASCII} characters.  For
	Unicode characters beyond the plain ASCII range, the match
	is based on {mansection I Glossarydisambig:bytes} and the result
