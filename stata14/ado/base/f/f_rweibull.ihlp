...
{p2colset 8 22 22 2}{...}
{p2col: Description:}Weibull variates with shape {it:a} and scale {it:b}{p_end}

{p2col:}The variates {it:x} are generated by {it:x} = 
         {cmd:invweibull(}{it:a}{cmd:,}{it:b}{cmd:,0,}{it:u}{cmd:)}, where {it:u} is a random
...
{p2colset 8 22 22 2}{...}
{p2col: Description:}Weibull variates with shape {it:a}, scale {it:b}, and
        location {it:g}{p_end}

{p2col:}The variates {it:x} are generated by {it:x} = 
         {cmd:invweibull(}{it:a}{cmd:,}{it:b}{cmd:,}{it:g}{cmd:,}{it:u}{cmd:)}, where {it:u} is a random
	 uniform(0,1) variate.{p_end}
{p2col: Domain {it:a}:}0.01 to 1e+6{p_end}
{p2col: Domain {it:b}:}1e-323 to 8e+307{p_end}
