...
{p2colset 5 23 25 2}{...}
{p2col :{manlink D filefilter} {hline 2}}Convert ASCII or binary patterns in
a file{p_end}
{p2colreset}{...}
...
{pstd}
Unicode is not directly supported at this time, but UTF-8 encoded files can be
...
{pstd}
Unicode is not directly supported at this time, but you can try to
