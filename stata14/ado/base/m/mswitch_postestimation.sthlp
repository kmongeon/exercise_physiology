...
{p2colset 5 36 38 2}{...}
{p2col :{manlink TS mswitch postestimation} {hline 2}}Postestimation tools for
mswitch{p_end}
...
{synopt :{cmd:rmse(}{it:stub}{cmd:*}{c |}{it:{help newvarlist}}{cmd:)}}put estimated root mean squared errors of predicted statistics in new variables{p_end}
...
{phang}
{cmd:rmse(}{it:stub}{cmd:*}{c |}{it:{help newvarlist}}{cmd:)} puts the root
