...
{p2colset 5 24 26 2}{...}
{p2col:{manlink M-5 solvenl()} {hline 2}}Solve systems of nonlinear equations{p_end}
{p2colreset}{...}
...
({help mf_solvenl##BurdenFaires2011:Burden and Faires 2011}, 646)
...
The default is 16,000 or whatever was previously declared by using
{cmd:set maxiter} (see {helpb maximize:[R] maximize}).
...
{marker BurdenFaires2011}{...}
{phang}
Burden, R. L., and J. D. Faires. 2011. {it:Numerical Analysis}. 9th ed.
Boston: Brooks/Cole.
{p_end}
