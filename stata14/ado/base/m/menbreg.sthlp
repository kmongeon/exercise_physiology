...
{p2colset 5 21 23 2}{...}
{synopt :{manlink ME menbreg} {hline 2}}Multilevel mixed-effects negative binomial
regression{p_end}
{p2colreset}{...}
...
{synopt :{opt nolr:test}}do not perform likelihood-ratio test comparing with negative binomial regression{p_end}
...
{phang}
{opt nolrtest} prevents {cmd:menbreg} from performing a likelihood-ratio test
that compares the mixed-effects negative binomial model with standard
(marginal) negative binomial regression.  This option may also be specified
