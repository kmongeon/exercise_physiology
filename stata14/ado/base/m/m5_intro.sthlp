...
{phang}
{manlink M-5 intro} {hline 2} Alphabetical index to functions
...
{p2col:{bf:{help mf_subdiagget:subdiagget()}}}extract matrix subdiagonals{p_end}
...
{p2col:{bf:{help mf_vech_lower:vech_lower()}}}same as {helpb mf_vec:vech()} but omits the main diagonal{p_end}
