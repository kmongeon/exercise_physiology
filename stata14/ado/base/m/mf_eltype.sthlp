...
{p 4 8 2}
{manlink M-5 eltype()} {hline 2} Element type, organizational type, and type
name of object
...
{p 4 4 2}
{cmd:classname()} returns the name "cA" if the object is a class cA scalar. 
The function returns "" if the object has element type other than {cmd:class} 
or has organizational type other than {cmd:scalar}. 

{p 4 4 2}
{cmd:structname()} returns the name "sA" if the object is a struct sA scalar. 
The function returns "" if the object has element type other than {cmd:struct} 
or has organizational type other than {cmd:scalar}. 
