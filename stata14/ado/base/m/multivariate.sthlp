...
{mansection BAYES bayesBAYES:{it:Stata Bayesian Analysis Reference Manual}}.
...
{mansection IRT irtItemResponse Theory:{it:Stata Item Response Theory Reference Manual}}.
...
{pstd}
{mansection IRT irtItemResponse Theory:{it:Stata Item Response Theory Reference Manual}}{p_end}
{p2colreset}{...}
