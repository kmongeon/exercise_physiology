...
{viewerjumpto "Postestimation commands" "mgarch dcc postestimation##description"}{...}
{viewerjumpto "predict" "mgarch dcc postestimation##syntax_predict"}{...}
{viewerjumpto "margins" "mgarch dcc postestimation##syntax_margins"}{...}
...
{synopt:{helpb mgarch_dcc_postestimation##margins:margins}}marginal
