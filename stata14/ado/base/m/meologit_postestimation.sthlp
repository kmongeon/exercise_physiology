...
{viewerjumpto "Postestimation commands" "meologit postestimation##description"}{...}
{viewerjumpto "predict" "meologit postestimation##syntax_predict"}{...}
{viewerjumpto "margins" "meologit postestimation##syntax_margins"}{...}
{viewerjumpto "estat" "meologit postestimation##syntax_estat_group"}{...}
{viewerjumpto "Examples" "meologit postestimation##examples"}{...}
{title:Title}

{p2colset 5 37 39 2}{...}
{p2col :{manlink ME meologit postestimation} {hline 2}}Postestimation tools for meologit{p_end}
{p2colreset}{...}
...
{synoptline}
{synopt :{helpb meologit postestimation##estatgroup:estat group}}summarize
...
{synopt:{helpb meologit_postestimation##margins:margins}}marginal
	means, predictive margins, marginal effects, and average marginal
	effects{p_end}
INCLUDE help post_marginsplot
INCLUDE help post_nlcom
{synopt :{helpb meologit postestimation##predict:predict}}predictions, residuals, influence statistics, and other diagnostic measures{p_end}
...
{synoptline}
{syntab :Main}
{synopt :{opt cond:itional}{cmd:(}{it:{help meologit_postestimation##ctype:ctype}}{cmd:)}}compute {it:statistic} conditional on estimated random effects; default is {cmd:conditional(ebmeans)}{p_end}
...
{syntab :Integration}
{synopt :{it:{help meologit_postestimation##int_options:int_options}}}integration
	options{p_end}
{synoptline}
{p 4 6 2}
...
get if you used the {cmd:tabulate} command on each group variable
individually.
