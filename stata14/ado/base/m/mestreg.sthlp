...
{p2colset 5 21 23 2}{...}
{p2col :{manlink ME mestreg} {hline 2}}Multilevel mixed-effects parametric survival models{p_end}
{p2colreset}{...}
...
{cmd:mestreg} {it:fe_equation} [{cmd:||} {it:re_equation}]
	...
	{opth d:istribution(mestreg##distname:distname)}
...
{synoptline}
{syntab:Model}
{p2coldent :* {cmdab:d:istribution(}{it:{help mestreg##distname:distname}}{cmd:)}}specify survival distribution{p_end}
...
{p 4 6 2}
{opt by} and {opt svy} are allowed; see {help prefix}.
{p_end}
{p 4 6 2}
...
{phang}
{opt nolrtest} suppresses the likelihood-ratio test of the null hypothesis
that all random effects are zero.  This option may also be specified upon
...
{phang2}{cmd:. mestreg education njobs prestige i.female || id:, distribution(lognormal)}
