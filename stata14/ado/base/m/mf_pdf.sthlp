...
{p 4 8 2}
{manlink M-5 Pdf*()} {hline 2} Create a PDF file 
...
{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_bwidth:{bf:setBorderWidth(}}{it:real scalar sz}{help mf_pdf##des_table_bwidth:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_bcolor:{bf:setBorderColor(}}{it:real scalar r}{cmd:,}
{it:real scalar g}{cmd:,} 
{it:real scalar b}{help mf_pdf##des_table_bcolor:{bf:)}}
...
{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_bwidths:{bf:setCellBorderWidths(}}{it:real scalar i}{cmd:,}
{it:real scalar j}{cmd:,} 
{it:real scalar sz}{help mf_pdf##des_table_cell_bwidths:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_left_bwidth:{bf:setCellLeftBorderWidth(}}{it:real scalar i}{cmd:,} 
{it:real scalar j}{cmd:,}
{it:real scalar sz}{help mf_pdf##des_table_cell_left_bwidth:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_right_bwidth:{bf:setCellRightBorderWidth(}}{it:real scalar i}{cmd:,} 
{it:real scalar j}{cmd:,}
{it:real scalar sz}{help mf_pdf##des_table_cell_right_bwidth:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_top_bwidth:{bf:setCellTopBorderWidth(}}{it:real scalar i}{cmd:,}
{it:real scalar j}{cmd:,}
{it:real scalar sz}{help mf_pdf##des_table_cell_top_bwidth:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_btm_bwidth:{bf:setCellBottomBorderWidth(}}{it:real scalar i}{cmd:,} 
{it:real scalar j}{cmd:,}
{it:real scalar sz}{help mf_pdf##des_table_cell_btm_bwidth:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_margins:{bf:setCellMargins(}}{it:real scalar i}{cmd:,}
{it:real scalar j}{cmd:,}
{it:real scalar sz}{help mf_pdf##des_table_cell_margins:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_left_margin:{bf:setCellLeftMargin(}}{it:real scalar i}{cmd:,} 
{it:real scalar j}{cmd:,}
{it:real scalar sz}{help mf_pdf##des_table_cell_left_margin:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_right_margin:{bf:setCellRightMargin(}}{it:real scalar i}{cmd:,} 
{it:real scalar j}{cmd:,}
{it:real scalar sz}{help mf_pdf##des_table_cell_right_margin:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_top_margin:{bf:setCellTopMargin(}}{it:real scalar i}{cmd:,} 
{it:real scalar j}{cmd:,}
{it:real scalar sz}{help mf_pdf##des_table_cell_top_margin:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_cell_btm_margin:{bf:setCellBottomMargin(}}{it:real scalar i}{cmd:,} 
{it:real scalar j}{cmd:,}
{it:real scalar sz}{help mf_pdf##des_table_cell_btm_margin:{bf:)}}
...
{it:real scalar rownames}{help mf_pdf##des_table_matrix:{bf:)}}

{p 8 25 2}
{it:void}{bind: }
{help mf_pdf##des_table_mata:{bf:fillMataMatrix(}}{it:real matrix name}[{cmd:,} 
{it: real scalar i}{cmd:,}
{it:real scalar j}]{help mf_pdf##des_table_mata:{bf:)}}
...
{cmd:setBorderWidth(}{it:sz}{cmd:)}
sets the width of the border for all cells.

{phang2}
{marker des_table_bcolor}{...}
{cmd:setBorderColor(}{it:r}{cmd:,} {it:g}{cmd:,} {it:b}{cmd:)}
sets the color of the border for all cells using the specified RGB values in
the range [0,255].  Note that only integer values can be used.
...
{cmd:setCellBorderWidths(}{it:i}{cmd:,} {it:j}{cmd:,} {it:sz}{cmd:)}
sets the border width of the cell of the {it:i}th row and {it:j}th column.
If {it:sz} equals 0, the border of the cell is not shown.

{phang2}
{marker des_table_cell_left_bwidth}{...}
{cmd:setCellLeftBorderWidth(}{it:i}{cmd:,} {it:j}{cmd:,} {it:sz}{cmd:)}
sets the width of the left border of the cell of the {it:i}th row and {it:j}th
column.  If {it:sz} equals 0, the left border of the cell is not shown.

{phang2}
{marker des_table_cell_right_bwidth}{...}
{cmd:setCellRightBorderWidth(}{it:i}{cmd:,} {it:j}{cmd:,} {it:sz}{cmd:)}
sets the width of the right border of the cell of the {it:i}th row and {it:j}th
column.  If {it:sz} equals 0, the right border of the cell is not shown.

{phang2}
{marker des_table_cell_top_bwidth}{...}
{cmd:setCellTopBorderWidth(}{it:i}{cmd:,} {it:j}{cmd:,} {it:sz}{cmd:)}
sets the width of the top border of the cell of the {it:i}th row and {it:j}th 
column.  If {it:sz} equals 0, the top border of the cell is not shown.

{phang2}
{marker des_table_cell_btm_bwidth}{...}
{cmd:setCellBottomBorderWidth(}{it:i}{cmd:,} 
{it:j}{cmd:,} {it:sz}{cmd:)}
sets the width of the bottom border of the cell of the {it:i}th row and 
{it:j}th column.  If {it:sz} equals 0, the bottom border of the cell
is not shown.

{phang2}
{marker des_table_cell_margins}{...}
{cmd:setCellMargins(}{it:i}{cmd:,} {it:j}{cmd:,} {it:sz}{cmd:)}
sets the content margins of the cell of the {it:i}th row and {it:j}th column.

{phang2}
{marker des_table_cell_left_margin}{...}
{cmd:setCellLeftMargin(}{it:i}{cmd:,} {it:j}{cmd:,} {it:sz}{cmd:)}
sets the left content margin of the cell of the {it:i}th row and {it:j}th 
column.

{phang2}
{marker des_table_cell_right_margin}{...}
{cmd:setCellRightMargin(}{it:i}{cmd:,} {it:j}{cmd:,} {it:sz}{cmd:)}
sets the right content margin of the cell of the {it:i}th row and {it:j}th
column.

{phang2}
{marker des_table_cell_top_margin}{...}
{cmd:setCellTopMargin(}{it:i}{cmd:,} {it:j}{cmd:,} {it:sz}{cmd:)}
sets the top content margin of the cell of the {it:i}th row and {it:j}th
column.

{phang2}
{marker des_table_cell_btm_margin}{...}
{cmd:setCellBottomMargin(}{it:i}{cmd:,} {it:j}{cmd:,} {it:sz}{cmd:)}
sets the bottom content margin of the cell of the {it:i}th row and {it:j}th
column.
...
{cmd:fillStataMatrix(}{it:name}{cmd:,} {it:colnames}{cmd:,} {it:rownames}{cmd:)}
...
{help matrix_rownames:matrix rownames}.  The matrix is identified by 
{it:name}.  If the matrix does not exist, an error code will be returned.
...
{it:j}th column.  If the matrix does not exist, an error code will be returned.
