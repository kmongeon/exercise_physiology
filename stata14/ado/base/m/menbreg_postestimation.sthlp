...
{viewerjumpto "estat" "menbreg postestimation##syntax_estat"}{...}
{viewerjumpto "Examples" "menbreg postestimation##examples"}{...}
{title:Title}

{p2colset 5 36 38 2}{...}
{p2col :{manlink ME menbreg postestimation} {hline 2}}Postestimation tools for
menbreg{p_end}
{p2colreset}{...}
...
{synoptline}
{synopt :{helpb menbreg postestimation##estatgroup:estat group}}summarize
...
{synopt:{helpb menbreg_postestimation##margins:margins}}marginal
	means, predictive margins, marginal effects, and average marginal
	effects{p_end}
INCLUDE help post_marginsplot
INCLUDE help post_nlcom
{synopt :{helpb menbreg postestimation##predict:predict}}predictions, residuals, influence statistics, and other diagnostic measures{p_end}
...
{synoptline}
{syntab :Main}
{synopt :{opt cond:itional}{cmd:(}{it:{help menbreg_postestimation##ctype:ctype}}{cmd:)}}compute {it:statistic} conditional on estimated random effects; default is {cmd:conditional(ebmeans)}{p_end}
...
{syntab :Integration}
{synopt :{it:{help menbreg_postestimation##int_options:int_options}}}integration
	options{p_end}
{synoptline}
{p 4 6 2}
{cmd:pearson},
