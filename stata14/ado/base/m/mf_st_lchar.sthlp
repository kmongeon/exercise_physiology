...
{p 4 4 2}
In Stata/IC, the maximum number of variables is 2,047.
...
2,047*129 = 264,063 characters.

{p 4 4 2}
In Stata/SE and Stata/MP, the maximum number of variables is 5,000 by default
