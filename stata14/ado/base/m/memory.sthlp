...
default unit is {cmd:b}.
	   ...
	   {c |} {cmd:maxvar}      {c |}   {cmd:5000}  {c |}          {cmd:2048}          {cmd:32767}  {c |} (MP & SE)
	   {c |}             {c |}   {cmd:2047}  {c |}          {cmd:2047}           {cmd:2047}  {c |} (IC)
...
The default value of {cmd:maxvar} is 5,000 for Stata/MP and Stata/SE,
2,047 for Stata/IC, and 99 for Small Stata.  With Stata/MP and Stata/SE,
this default value may be increased by using {cmd:set maxvar}.
The default value is fixed for both Stata/IC and Small Stata.
...
{p 6 10 2}
3.
The maximum number of observations is fixed at 281,474,976,710,655 for
Stata/MP and is fixed at 2,147,483,647 for Stata/SE and Stata/IC regardless 
