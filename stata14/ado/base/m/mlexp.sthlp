...
{p2colset 5 18 20 2}{...}
{p2col :{manlink R mlexp} {hline 2}}Maximum likelihood estimation of 
...
{p 4 6 2}
{opt debug} and {opt coeflegend} do not appear in the dialog box.{p_end}
{p 4 6 2}
...
{pstd}
Same as above, using {help mlexp##Greene2012:Greene's} (2012, 691, fn. 7)
