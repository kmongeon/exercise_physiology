...
{p 6 25 2}
{it:(varies)}{bind:      }
{help mf_optimize##i_evaluations:{bf:optimize_init_evaluations(}{it:S}{bf:,} {c -(}{bf:"off"}|{bf:"on"}{c )-}{bf:)}}

{p 6 25 2}
{it:(varies)}{bind:      }
{help mf_optimize##i_constr:{bf:optimize_init_constraints(}{it:S} [{bf:,} {it:real matrix Cc}]{bf:)}}

{p 6 25 2}
{it:(varies)}{bind:      }
{help mf_optimize##i_verbose:{bf:optimize_init_verbose(}{it:S} [{bf:,} {it:real scalar verbose}]{bf:)}}


{p 6 25 2}
{it:real rowvector}
{help mf_optimize##optimize:{bf:optimize(}{it:S}{bf:)}}

{p 6 25 2}
{it:real scalar}{bind:  }
{help mf_optimize##_optimize:{bf:_optimize(}{it:S}{bf:)}}

{p 6 25 2}
{it:void}{bind:          }
{help mf_optimize##eval:{bf:optimize_evaluate(}{it:S}{bf:)}}

{p 6 25 2}
{it:real scalar}{bind:  }
{help mf_optimize##_eval:{bf:_optimize_evaluate(}{it:S}{bf:)}}


{p 6 25 2}
{it:real rowvector}
{help mf_optimize##r_params:{bf:optimize_result_params(}{it:S}{bf:)}}

{p 6 25 2}
{it:real scalar}{bind:   }
{help mf_optimize##r_value:{bf:optimize_result_value(}{it:S}{bf:)}}

{p 6 25 2}
{it:real scalar}{bind:   }
{help mf_optimize##r_value:{bf:optimize_result_value0(}{it:S}{bf:)}}

{p 6 25 2}
{it:real rowvector}
{help mf_optimize##r_gradient:{bf:optimize_result_gradient(}{it:S}{bf:)}}

{p 6 25 2}
{it:real matrix}{bind:   }
{help mf_optimize##r_scores:{bf:optimize_result_scores(}{it:S}{bf:)}}

{p 6 25 2}
{it:real matrix}{bind:   }
{help mf_optimize##r_hessian:{bf:optimize_result_Hessian(}{it:S}{bf:)}}

{p 6 25 2}
{it:real matrix}{bind:   }
{help mf_optimize##r_v:{bf:optimize_result_V(}{it:S}{bf:)}}

{p 6 25 2}
{it:string scalar}{bind: }
{help mf_optimize##r_v:{bf:optimize_result_Vtype(}{it:S}{bf:)}}

{p 6 25 2}
{it:real matrix}{bind:   }
{help mf_optimize##r_v_all:{bf:optimize_result_V_oim(}{it:S}{bf:)}}

{p 6 25 2}
{it:real matrix}{bind:   }
{help mf_optimize##r_v_all:{bf:optimize_result_V_opg(}{it:S}{bf:)}}

{p 6 25 2}
{it:real matrix}{bind:   }
{help mf_optimize##r_v_all:{bf:optimize_result_V_robust(}{it:S}{bf:)}}

{p 6 25 2}
{it:real scalar}{bind:   }
{help mf_optimize##r_iterations:{bf:optimize_result_iterations(}{it:S}{bf:)}}

{p 6 25 2}
{it:real scalar}{bind:   }
{help mf_optimize##r_converged:{bf:optimize_result_converged(}{it:S}{bf:)}}

{p 6 25 2}
{it:real colvector}
{help mf_optimize##r_ilog:{bf:optimize_result_iterationlog(}{it:S}{bf:)}}

{p 6 25 2}
{it:real rowvector}{...}
{help mf_optimize##r_evaluations:{bf:optimize_result_evaluations(}{it:S}{bf:)}}

{p 6 25 2}
{it:real scalar}{bind:   }
{help mf_optimize##r_error:{bf:optimize_result_errorcode(}{it:S}{bf:)}}

{p 6 25 2}
{it:string scalar}{bind: }
{help mf_optimize##r_error:{bf:optimize_result_errortext(}{it:S}{bf:)}}

{p 6 25 2}
{it:real scalar}{bind:   }
{help mf_optimize##r_error:{bf:optimize_result_returncode(}{it:S}{bf:)}}


{p 6 25 2}
{it:void}{bind:          }
{help mf_optimize##query:{bf:optimize_query(}{it:S}{bf:)}}
...
{p 4 4 2}
{cmd:optimize_init_narguments(}{it:S}{cmd:)} returns the number of extra
arguments that are passed to the evaluator function.
...
{helpb mf_invsym:invsym({it:-H})} * ({it:S'S}) *
{helpb mf_invsym:invsym({it:-H})},
which is the robust estimate of variance, also known as the sandwich estimator
of variance.  {cmd:optimize_result_V_robust()} is available only when the
evaluator function is type {cmd:gf}, but regardless of the technique used.
