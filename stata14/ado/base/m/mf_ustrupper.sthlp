...
{p 4 27 2}
{manlink M-5 ustrupper()} {hline 2} Convert Unicode string to uppercase, lowercase, or titlecase
...
string {it:s} to
{mansection I Glossarytitlecase:titlecase}. Note that a Unicode word is
