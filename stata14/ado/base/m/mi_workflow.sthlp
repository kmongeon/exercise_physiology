...
{* ----------------------------------------------------- junk1.smcl ---}{...}
{com}. webuse mheart5
{txt}(Fictional heart attack data)

{com}. describe

{txt}Contains data from {res}http://www.stata-press.com/data/r14/mheart5.dta
{txt}  obs:{res}           154                          Fictional heart attack data
{txt} vars:{res}             6                          19 Jun 2014 10:50
...
{txt}Contains data from {res}http://www.stata-press.com/data/r14/mheart5.dta
{txt}  obs:{res}           154                          Fictional heart attack data
{txt} vars:{res}             9                          19 Jun 2014 10:50
...
Style:
{res:flong}{break}
{break}last {bf:mi update} 14nov2014 14:56:41,
0 seconds ago
...
Style:
{res:flong}{break}
{break}last {bf:mi update} 14nov2014 14:56:42,
0 seconds ago
...
{txt}Contains data from {res}http://www.stata-press.com/data/r14/mheart5.dta
{txt}  obs:{res}         3,234                          Fictional heart attack data
{txt} vars:{res}             9                          14 Nov 2014 14:56
...
{txt}Contains data from {res}http://www.stata-press.com/data/r14/mheart5.dta
{txt}  obs:{res}           714                          Fictional heart attack data
{txt} vars:{res}             9                          14 Nov 2014 14:56
...
{txt}Contains data from {res}http://www.stata-press.com/data/r14/mheart5.dta
{txt}  obs:{res}           154                          Fictional heart attack data
{txt} vars:{res}            47                          14 Nov 2014 14:56
...
{txt}{col 51}Average RVI{col 67}=     0.1104
{txt}{col 51}Largest FMI{col 67}=     0.3267
{txt}DF adjustment:{ralign 15: {res:Large sample}}{col 51}DF:     min{col 67}=     186.13
{txt}{col 51}        avg{col 67}=   67625.01
{txt}{col 51}        max{col 67}=  220747.20
{txt}Model F test:{ralign 16: {res:Equal FMI}}{col 51}F(    5{txt},6512.5{txt}){col 67}=       3.08
{txt}Within VCE type: {ralign 12:{res:OIM}}{col 51}Prob > F{col 67}=     0.0089

{txt}{hline 13}{c TT}{hline 11}{hline 11}{hline 9}{hline 8}{hline 13}{hline 12}
{col 1}      attack{col 14}{c |}      Coef.{col 26}   Std. Err.{col 38}      t{col 46}   P>|t|{col 54}     [95% Con{col 67}f. Interval]
{hline 13}{c +}{hline 11}{hline 11}{hline 9}{hline 8}{hline 13}{hline 12}
{space 6}smokes {c |}{col 14}{space 2} 1.171797{col 26}{space 2} .3573997{col 37}{space 1}    3.28{col 46}{space 3}0.001{col 54}{space 4} .4712929{col 67}{space 3}   1.8723
{txt}{space 9}age {c |}{col 14}{space 2}  .028737{col 26}{space 2} .0165865{col 37}{space 1}    1.73{col 46}{space 3}0.083{col 54}{space 4}-.0038133{col 67}{space 3} .0612873
{txt}{space 9}bmi {c |}{col 14}{space 2} .1017045{col 26}{space 2} .0535639{col 37}{space 1}    1.90{col 46}{space 3}0.059{col 54}{space 4} -.003966{col 67}{space 3} .2073749
{txt}{space 6}hsgrad {c |}{col 14}{space 2} .1501389{col 26}{space 2} .4038092{col 37}{space 1}    0.37{col 46}{space 3}0.710{col 54}{space 4}-.6413206{col 67}{space 3} .9415985
{txt}{space 6}female {c |}{col 14}{space 2}-.1022359{col 26}{space 2} .4138162{col 37}{space 1}   -0.25{col 46}{space 3}0.805{col 54}{space 4}-.9133052{col 67}{space 3} .7088334
{txt}{space 7}_cons {c |}{col 14}{space 2}-4.979444{col 26}{space 2} 1.829307{col 37}{space 1}   -2.75{col 46}{space 3}0.007{col 54}{space 4}-8.580825{col 67}{space 3}-1.378062
