...
{p2colset 5 23 25 2}{...}
{synopt :{manlink ME mecloglog} {hline 2}}Multilevel mixed-effects complementary
...
{synopt :{opt nolr:test}}do not perform likelihood-ratio test comparing with
...
{phang}
{opt nolrtest} prevents {cmd:mecloglog} from performing a likelihood-ratio
test that compares the mixed-effects complementary log-log model with standard
(marginal) complementary log-log regression.  This option may also be
