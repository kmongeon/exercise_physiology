...
{p 4 8 2}
{manlink M-5 ustrtrim()} {hline 2} Remove Unicode whitespace characters
...
See {browse "http://unicode.org/charts/uca/chart_Whitespace.html"} for the 
list of all Unicode whitespace characters.
