...
{opt nofet:able}, and
{opt estm:etric}.
These options are relevant only with the mixed-effects commands
{cmd:meqrlogit} (see {manhelp meqrlogit ME}),
{cmd:meqrpoisson} (see {manhelp meqrpoisson ME}), and
