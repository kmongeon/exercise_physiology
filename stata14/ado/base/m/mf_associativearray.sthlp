...
{p 4 8 2}
{manlink M-5 AssociativeArray()} {hline 2} Associative arrays (class)
...
{right:{it:first location or NULL                    }}
{col 9}{...}
{it:loc}{cmd: = }{it:A}{cmd:.next(}{it:loc}{cmd:)}{...}
{right:{it:next location or NULL                     }}
{col 9}{...}
