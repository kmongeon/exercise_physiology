...
Remarks are presented under the following headings:
	...
	{help mf_xl##syn_format_funcs:Formatting functions}
	  {help mf_xl##syn_format_numeric:Numeric formatting}
	    {help mf_xl##syn_format_custom:Custom formatting}
	    {help mf_xl##syn_format_text_color:Custom formatting: Text color}
	    {help mf_xl##syn_format_cond:Custom formatting: Conditional formatting}
	  ...
	  {help mf_xl##syn_format_colors:Format colors}
...
{it:{help mf_xl##def_B:B}}{cmd:.set_number_format(}{it:row}{cmd:,}
     {it:col}{cmd:,} {cmd:"}{it:format}{cmd:"}{cmd:)}
...
{it:{help mf_xl##def_B:B}}{cmd:.set_border(}{it:row}{cmd:,}
     {it:col}{cmd:,} {cmd:"}{it:style}{cmd:"}[{cmd:,} 
...
{it:{help mf_xl##def_B:B}}{cmd:.set_fill_pattern(}{it:row}{cmd:,}
     {it:col}{cmd:,} {cmd:"}{it:pattern}{cmd:"}{cmd:,}
     {cmd:"}{it:fgcolor}{cmd:"} [{cmd:,} {it:"bgcolor"}]{cmd:)}
...
{help mf_xl##syn_format_colors:{it:Format colors}} or an RGB (red,
