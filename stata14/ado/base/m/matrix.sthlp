...
{title:5.  Submatrix extraction}{right:(see {mansection P matrixdefineRemarksandexamplesSubscriptingandelement-by-elementdefinition:{bf:[P] matrix define}};  }
...
{title:6.  Submatrix substitution}{right:(see {mansection P matrixdefineRemarksandexamplesSubscriptingandelement-by-elementdefinition:{bf:[P] matrix define}};  }
...
{right:(see {mansection P matrixdefineRemarksandexamplesMacroextendedfunctions:{bf:[P] matrix define}};  }
