...
{viewerjumpto "Postestimation commands" "mgarch vcc postestimation##description"}{...}
{viewerjumpto "predict" "mgarch vcc postestimation##syntax_predict"}{...}
{viewerjumpto "margins" "mgarch vcc postestimation##syntax_margins"}{...}
...
{synopt:{helpb mgarch_vcc_postestimation##margins:margins}}marginal
