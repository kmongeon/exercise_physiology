{smcl}
{* *! version 1.0.4  14oct2016}{...}
{viewerdialog power "dialog power_cox"}{...}
{vieweralsosee "[PSS] power cox" "mansection PSS powercox"}{...}
{vieweralsosee "" "--"}{...}
{vieweralsosee "[PSS] power" "help power"}{...}
{vieweralsosee "[PSS] power exponential" "help power exponential"}{...}
...
{viewerjumpto "Remarks" "power_cox##remarks"}{...}
{viewerjumpto "Examples" "power_cox##examples"}{...}
{viewerjumpto "Stored results""power_cox##results"}{...}
{title:Title}

{p2colset 5 24 26 2}{...}
{p2col :{manlink PSS power cox} {hline 2}}Power analysis for the 
...
see {manhelp power##mainopts PSS: power}.  The {cmd:nfractional} option is
...
Also see the {it:{mansection PSS powercoxSyntaxcolumn:column}} table in
{bf:[PSS] power cox} for a list of symbols used by the graphs.
