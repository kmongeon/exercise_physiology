...
{vieweralsosee "[PSS] power twovariances" "mansection PSS powertwovariances"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Remarks" "power_twovariances##remarks"}{...}
{viewerjumpto "Examples" "power_twovariances##examples"}{...}
{viewerjumpto "Stored results""power_twovariances##stored_results"}{...}
{title:Title}

{p2colset 5 33 35 2}{...}
{p2col :{manlink PSS power twovariances} {hline 2}}Power analysis for a
two-sample variance-ratio test{p_end} {p2colreset}{...}
...
{syntab:Iteration}
{synopt: {opt init(#)}}initial value for the sample sizes or
...
option is not allowed with effect-size determination.
...
Also see the {mansection pss powertwovariancesSyntaxcolumn:column} table in
{bf:[PSS] power twovariances} for a list of symbols used by the graphs.
...
{marker remarks}{...}
{title:Using power twovariances}
