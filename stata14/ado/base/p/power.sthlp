...
{p2colset 5 20 22 2}{...}
{p2col :{manlink PSS power} {hline 2}}Power and sample-size analysis for hypothesis tests{p_end}
{p2colreset}{...}
...
display results as a table; see {helpb power table:[PSS] power, table}{p_end}
...
({helpb power_opttable:[PSS] power, table}) and on a graph
...
combinations of the two values in two study parameters: (a_1,b_1),
...
{helpb power_opttable:[PSS] power, table} for details.
...
{helpb power_optgraph:[PSS] power, graph} for details.
