{* *! version 1.0.3  28oct2013}{...}
{* changes to this file should also be made to pss_rrestest_sc.ihlp}
{synopt:{cmd: r(alpha)}}significance level{p_end}
{synopt:{cmd: r(alpha_a)}}actual significance level of the Fisher's exact test{p_end}
...
{synopt:{cmd: r(nratio)}}ratio of sample sizes, N2/N1{p_end}
