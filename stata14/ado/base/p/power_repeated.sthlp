{smcl}
{* *! version 1.1.6  20oct2016}{...}
{viewerdialog power "dialog power_repeated"}{...}
{vieweralsosee "[PSS] power repeated" "mansection PSS powerrepeated"}{...}
{vieweralsosee "" "--"}{...}
...
{vieweralsosee "[PSS] power twoway" "help power twoway"}{...}
...
{viewerjumpto "Remarks" "power_repeated##remarks"}{...}
{viewerjumpto "Examples" "power_repeated##examples"}{...}
{viewerjumpto "Stored results""power_repeated##stored_results"}{...}
{title:Title}

{p2colset 5 29 31 2}{...}
{p2col :{manlink PSS power repeated} {hline 2}}Power analysis for 
repeated-measures analysis of variance{p_end} {p2colreset}{...}
...
{syntab:Iteration}
{synopt: {opt init(#)}}initial value for sample sizes or the effect size;
...
given sample size, power, and number of groups.  Also see {manhelp power PSS}
...
Also see the {mansection PSS powerrepeatedSyntaxcolumn:column} table in
...
power.  See 
{it:{mansection PSS powertwowayRemarksandexamplessub1:Alternative ways of specifying effect}} in 
{bf:[PSS] power twoway}; substitute {cmd:ngroups()} for
