...
{viewerjumpto "Remarks" "power_onevariance##remarks"}{...}
{viewerjumpto "Examples" "power_onevariance##examples"}{...}
{viewerjumpto "Stored results" "power_onevariance##stored_results"}{...}
{title:Title}

{p2colset 5 32 34 2}{...}
{p2col :{manlink PSS power onevariance} {hline 2}}Power analysis for a
...
Also see the {mansection pss poweronevarianceSyntaxcolumn:column} table in
{bf:[PSS] power onevariance} for a list of symbols used by the graphs.
...
the {cmd:init()} option. See {manhelp power PSS} for the descriptions of other
...
{synopt:{cmd: r(init)}}initial value for the sample size or the variance{p_end}
