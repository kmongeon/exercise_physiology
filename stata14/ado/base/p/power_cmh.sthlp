...
{vieweralsosee "[PSS] power cmh" "mansection PSS powercmh"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Remarks" "power_cmh##remarks"}{...}
{viewerjumpto "Examples" "power_cmh##examples"}{...}
{viewerjumpto "Stored results""power_cmh##results"}{...}
{title:Title}

{p2colset 5 24 36 2}{...}
{p2col :{manlink PSS power cmh} {hline 2}}Power analysis for a 
...
{syntab:Iteration}
{synopt: {opt init(#)}}initial value for the sample sizes or the effect
     size{p_end}
...
{synopt :{opt N_per_group}}number of subjects per stratum{p_end}
...
Also see the {mansection PSS powercmhSyntaxcolumn:{it:column}} table in
{bf:[PSS] power cmh} for a list of symbols used by the graphs.
...
see {mansection PSS powercmhRemarksandexamplessub1:{it:Alternative ways of specifying probabilities}}
in {bf:[PSS] power cmh}.
...
{phang2}{cmd:. power cmh 0.25 0.3 0.3 0.35, or(1.8) strweights(15 40 35 10) sratios(0.4 0.4 0.4 0.4)}
...
{synopt:{cmd: r(init)}}initial value for the sample sizes or effect size{p_end}
