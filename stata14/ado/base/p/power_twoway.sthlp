{smcl}
{* *! version 1.0.9  20oct2016}{...}
{viewerdialog power "dialog power_twoway"}{...}
{vieweralsosee "[PSS] power twoway" "mansection PSS powertwoway"}{...}
{vieweralsosee "" "--"}{...}
{vieweralsosee "[PSS] power" "help power"}{...}
{vieweralsosee "[PSS] power oneway" "help power oneway"}{...}
...
{viewerjumpto "Remarks" "power_twoway##remarks"}{...}
{viewerjumpto "Examples" "power_twoway##examples"}{...}
{viewerjumpto "Stored results""power_twoway##stored_results"}{...}
{title:Title}

{p2colset 5 27 29 2}{...}
{p2col :{manlink PSS power twoway} {hline 2}}Power analysis for two-way
...
{synopt:{cmdab:cellw:eights(}{help power_twoway##wgtspec:wgtspec}{cmd:)}}cell weights; default is one for each cell, meaning equal cell sizes{p_end}
...
{p2coldent:* {opth varreff:ect(numlist)}}variance explained by the tested
...
{syntab:Iteration}
{synopt: {opt init(#)}}initial value for the sample size or the effect size;
...
or their interaction.  Also see {manhelp power PSS} for a general introduction
...
Also see the {mansection PSS powertwowaySyntaxcolumn:column} table in
{bf:[PSS] power twoway} for a list of symbols used by the graphs.
...
specifying your own value in the {cmd:init()} option.  See {manhelp power PSS}
