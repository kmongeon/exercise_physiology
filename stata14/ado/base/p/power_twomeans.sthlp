...
{vieweralsosee "[PSS] power twomeans" "mansection PSS powertwomeans"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Remarks" "power_twomeans##remarks"}{...}
{viewerjumpto "Examples" "power_twomeans##examples"}{...}
{viewerjumpto "Stored results""power_twomeans##stored_results"}{...}
{title:Title}

{p2colset 5 29 31 2}{...}
{p2col :{manlink PSS power twomeans} {hline 2}}Power analysis for a two-sample
means test{p_end} {p2colreset}{...}
...
{synopt: {opt knownsd:s}}request computation assuming known standard deviations
for both groups; default is to assume unknown standard deviation{p_end}
...
given sample size, power, and the control-group mean.  Also see 
...
{pstd}
The following option is available with {cmd:power twomeans} but is not
...
{synopt:{cmd: r(init)}}initial value for the sample sizes or experimental-group mean{p_end}
