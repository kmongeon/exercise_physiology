...
{vieweralsosee "[PSS] power mcc" "mansection PSS powermcc"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Remarks" "power_mcc##remarks"}{...}
{viewerjumpto "Examples" "power_mcc##examples"}{...}
{viewerjumpto "Stored results""power_mcc##results"}{...}
{title:Title}

{p2colset 5 24 26 2}{...}
{p2col :{manlink PSS power mcc} {hline 2}}Power analysis for matched 
...
either as one number or as a list of values in parentheses; see {help numlist}.
...
{syntab:Iteration}
{synopt: {opt init(#)}}initial value for the sample size or the effect size{p_end}
...
see {manhelp power##mainopts PSS: power}.  The sample size in {cmd:n()} is the
...
see {mansection PSS powermccRemarksandexamplesex3:example 3} in
{bf:[PSS] power mcc} for discussion.
...
Also see the {mansection PSS powermccSyntaxcolumn:column} table in
{bf:[PSS] power mcc} for a list of symbols used by the graphs.
...
option to specify your own value. See {manhelp power PSS} for a description of
