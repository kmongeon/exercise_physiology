{* *! version 1.0.1  28oct2013}{...}
{* changes to this file should also be made to pss_rrestwotest_sc.ihlp}
{synopt:{cmd: r(alpha)}}significance level{p_end}
{synopt:{cmd: r(alpha_a)}}actual significance level of the binomial method{p_end}
