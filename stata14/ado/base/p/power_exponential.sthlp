{smcl}
{* *! version 1.0.5  20oct2016}{...}
{viewerdialog power "dialog power_exponential"}{...}
{vieweralsosee "[PSS] power exponential" "mansection PSS powerexponential"}{...}
{vieweralsosee "" "--"}{...}
{vieweralsosee "[PSS] power" "help power"}{...}
{vieweralsosee "[PSS] power cox" "help power cox"}{...}
{vieweralsosee "[PSS] power logrank" "help power logrank"}{...}
...
{viewerjumpto "Remarks" "power_exponential##remarks"}{...}
{viewerjumpto "Examples" "power_exponential##examples"}{...}
{viewerjumpto "Stored results""power_exponential##results"}{...}
{title:Title}

{p2colset 5 32 34 2}{...}
{p2col :{manlink PSS power exponential} {hline 2}}Power analysis for the 
exponential test{p_end}
{p2colreset}{...}
...
{synoptline}
{syntab:Main}
{p2coldent:* {opth t:ime(numlist)}}reference time {it:t} for survival
...
{cmd:nfractional}; see {manhelp power##mainopts PSS: power}.
...
{mansection PSS powerexponentialRemarksandexamplessub1:{it:Alternative ways of specifying effect}}
in {bf:[PSS] power exponential} for various specifications of an effect size.
...
see {mansection PSS powerexponentialRemarksandexamplessub1:{it:Alternative ways of specifying effect}}
in {bf:[PSS] power exponential} for details.
...
{mansection PSS powerexponentialRemarksandexamplesTheconditionalversusunconditionalapproaches:{it:The conditional versus unconditional approaches}}
and
{mansection PSS powerexponentialMethodsandformulas:{it:Methods and formulas}}
in {bf:[PSS] power exponential} for details.
...
{phang}
{cmd:onesided}, {cmd:parallel}; see {manhelp power##mainopts PSS: power}.
...
Also see the {it:{mansection PSS powerexponentialSyntaxcolumn:column}} table in
{bf:[PSS] power exponential} for a list of symbols used by the graphs.
...
see {manlink PSS unbalanced designs} for a description of how to specify an
unbalanced design.
...
{mansection PSS unbalanceddesignsRemarksandexamplesFractionalsamplesizes:{it:Fractional sample sizes}}
in {bf:[PSS] unbalanced designs} for an example.  The {cmd:nfractional} option
...
{mansection PSS powerexponentialRemarksandexamplesNonuniformaccrual:{it:Nonuniform accrual}}
in {bf:[PSS] power exponential}.
...
{mansection PSS powerexponentialRemarksandexamplesExponentiallossestofollow-up:{it:Exponential losses to follow-up}}
in {bf:[PSS] power exponential}.
...
{synopt:{cmd:r(nratio)}}ratio of sample sizes, {it:N2}/{it:N1}{p_end}
...
{synopt:{cmd:r(aptime)}}proportion of accrual period (if {cmd:atime()} is specified){p_end}
