{smcl}
{* *! version 1.0.7  14oct2016}{...}
{viewerdialog power "dialog power_twocorr"}{...}
{vieweralsosee "[PSS] power twocorrelations" "mansection PSS powertwocorrelations"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Remarks" "power_twocorrelations##remarks"}{...}
{viewerjumpto "Examples" "power_twocorrelations##examples"}{...}
{viewerjumpto "Stored results""power_twocorrelations##stored_results"}{...}
{title:Title}

{p2colset 5 36 38 2}{...}
{p2col :{manlink PSS power twocorrelations} {hline 2}}Power analysis for a
two-sample correlations test{p_end} {p2colreset}{...}
...
control-group correlation.  Also see {manhelp power PSS} for a general
...
Also see the {mansection pss powertwocorrelationsSyntaxcolumn:column} table in
{bf:[PSS] power twocorrelations} for a list of symbols used by the graphs.
...
{marker remarks}{...}
{title:Using power twocorrelations}
...
{manlink PSS unbalanced designs} for a description of
