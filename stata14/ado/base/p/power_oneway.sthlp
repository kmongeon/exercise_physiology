{smcl}
{* *! version 1.0.10  20oct2016}{...}
{viewerdialog power "dialog power_oneway"}{...}
{vieweralsosee "[PSS] power oneway" "mansection PSS poweroneway"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Remarks" "power_oneway##remarks"}{...}
...
{p2colset 5 27 29 2}{...}
{p2col :{manlink PSS power oneway} {hline 2}}Power analysis for one-way
...
number of groups.  Also see {manhelp power PSS} for a general introduction to
...
Also see the {mansection PSS poweronewaySyntaxcolumn:column} table in
{bf:[PSS] power oneway} for a list of symbols used by the graphs.
...
your own value in the {cmd:init()} option.  See {manhelp power PSS} for the
