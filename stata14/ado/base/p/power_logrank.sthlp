{smcl}
{* *! version 1.0.5  14oct2016}{...}
{viewerdialog power "dialog power_logrank"}{...}
{vieweralsosee "[PSS] power logrank" "mansection PSS powerlogrank"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Remarks" "power_logrank##remarks"}{...}
...
{p2colset 5 28 30 2}{...}
{p2col :{manlink PSS power logrank} {hline 2}}Power analysis for the 
log-rank test{p_end}
{p2colreset}{...}
...
{p2coldent:* {opth hr:atio(numlist)}}hazard ratio (effect size)
   ...
   not be combined with {cmd:lnhratio()}{p_end}
...
{manhelp power##mainopts PSS: power}.
...
{mansection PSS powerlogrankMethodsandformulas:{it:Methods and formulas}}
in {bf:[PSS] power logrank}.  {cmd:simpson()} may not be combined with
...
{mansection PSS powerlogrankMethodsandformulas:{it:Methods and formulas}} in
{bf:[PSS] power logrank}.  {cmd:st1()} may not be combined with
...
Also see the {mansection PSS powerlogrankSyntaxcolumn:column} table in
{bf:[PSS] power logrank} for a list of symbols used by the graphs.
...
{pstd}
The following option is available with {cmd:power logrank} but is not
...
balanced- or equal-allocation design; see {manlink PSS unbalanced designs} for
a description of how to specify an unbalanced design.
...
option {cmd:st1()}; see 
{mansection PSS powerlogrankRemarksandexamplesIncludinginformationaboutsubjectaccrual:{it:Including information about subject accrual}} 
in {bf:[PSS] power logrank} for details.
...
{cmd:init()} option. See {manhelp power PSS} for the descriptions of other options
