...
{vieweralsosee "[PSS] power trend" "mansection PSS powertrend"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Remarks" "power_trend##remarks"}{...}
{viewerjumpto "Examples" "power_trend##examples"}{...}
{viewerjumpto "Stored results""power_trend##results"}{...}
{title:Title}

{p2colset 5 26 28 2}{...}
{p2col :{manlink PSS power trend} {hline 2}}Power analysis for the 
...
increasing exposure levels; default is equally spaced values{p_end}
...
{syntab:Iteration}
{synopt: {opt init(#)}}initial value for the sample size for a two-sided test;
...
Also see the {mansection PSS powertrendSyntaxcolumn:column} table in
{bf:[PSS] power trend} for a list of symbols used by the graphs.
...
{mansection PSS powertrendRemarksandexamplessub1:{it:Alternative ways of specifying probabilities}}
in {bf:[PSS] power trend}. 
...
described in {mansection PSS powertrendRemarksandexamplessub1:{it:Alternative ways of specifying probabilities}}
in {bf:[PSS] power trend} can also be applied to the specification of exposure
levels.
...
See {manhelp power PSS} for a description of other options that control the
iteration process.
...
{synopt:{cmd:r(init)}}initial value for the sample size for a two-sided test{p_end}
