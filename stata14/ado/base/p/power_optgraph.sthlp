{smcl}
{* *! version 1.0.6  06jan2015}{...}
{viewerdialog power "dialog power_graph"}{...}
{vieweralsosee "[PSS] power, graph" "mansection PSS power,graph"}{...}
{vieweralsosee "" "--"}{...}
...
{p2colset 5 27 29 2}{...}
{p2col :{manlink PSS power, graph} {hline 2}}Graph results from the power
command{p_end}
{p2colreset}{...}
...
{synopt:{cmdab: collab:els(}{help power_optgraph##colspec:{it:collspec}}{cmd:)}}change 
...
{p 8 16 2}
{it:column} {cmd:"}{it:label}{cmd:"} [{it:column} {cmd:"}{it:label}{cmd:"} [...]]
...
often merely need to specify the {cmd:graph} option on your {cmd:power}
command.
...
{pmore}
        ...
        See {mansection PSS power,graphRemarksandexamplesDefaultgraphs:{it:Default graphs}}
	in {bf:[PSS] power, graph} for details.
...
{pmore}
	...
	{mansection PSS power,graphRemarksandexamplesChangingdefaultgraphdimensions:{it:Changing default graph dimensions}}
	in {bf:[PSS] power, graph}.
...
{pmore}
        See {mansection PSS power,graphRemarksandexamplesParallelplots:{it:Parallel plots}}
	in {bf:[PSS] power, graph} for an example of the {cmd:horizontal}
	suboption.

{phang}
{opt schemegrid} specifies that x and y grid lines not always be drawn on the
	power graph.  Instead, whether grid lines are drawn will be determined
	by the current {help scheme}.
...
{pmore}
        ...
        may be replaced by subsequent power graphs or other graphing
        commands.
...
{phang}
{cmd:collabels(}{help power_optgraph##colspec:{it:collspec}}{cmd:)} specifies 
...
{opt allsimplelabels} and {opt nosimplelabels}
        ...
        simple label is "power" or ".8" and of a nonsimple label is
        "power=.8".
...
{opt recast(plottype)}
	...
	{it:{help power_optgraph##plotopts:plot_options}}.  For details on those
...
{it:{mansection PSS power,graphRemarksandexamples:Remarks and examples}} in
{bf:[PSS] power, graph}.
