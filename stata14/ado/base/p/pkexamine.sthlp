...
measured concentration, the time of the last measurement, the elimination
time, the half-life, and the area under the concentration-time curve (AUC).
Three estimates of the area under the concentration-time curve from 0 to
infinity (AUC) are also calculated.
