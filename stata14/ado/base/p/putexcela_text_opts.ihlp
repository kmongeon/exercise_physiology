...
{* *! if similar changes need be made to putexcel_text_opts.ihlp.}{...}
{phang}
...
{pmore}
{it:color} may be 
a valid RGB value in the form {cmd:"}{it:### ### ###}{cmd:"} or may be one of
the colors listed in the table of colors in the
{help putexcel##Colors:{it:Appendix}} in {bf:[P] putexcel}.  If no {it:color}
...
{phang}
{opt script(sub|super|none)} changes the script style of the cell.
