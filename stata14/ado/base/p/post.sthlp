...
{p2colset 5 21 23 2}{...}
{p2col :{manlink P postfile} {hline 2}}Post results in Stata dataset{p_end}
{p2colreset}{...}
...
memory and periodically opens the dataset being built to append to the saved 
