...
{* *! if similar changes need be made to putexcel_num_opts.ihlp.}{...}
{marker nformat}{...}
{phang}
{opt nformat(excelnfmt)} changes the numeric format of a cell range.
Any valid Excel format is permitted.  Formats are formed from combinations of
...
A list of codes for common numeric formats is also shown in the  
{help putexcel##formats:{it:Appendix}} of {bf:[P] putexcel}.
{p_end}
