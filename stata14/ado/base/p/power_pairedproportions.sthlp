...
{viewerjumpto "Remarks" "power_pairedproportions##remarks"}{...}
{viewerjumpto "Examples" "power_pairedproportions##examples"}{...}
{viewerjumpto "Stored results" "power_pairedproportions##stored_results"}{...}
{title:Title}

{p2colset 5 38 40 2}{...}
{p2col :{manlink PSS power pairedproportions} {hline 2}}Power analysis for a
...
{syntab:Iteration}
{synopt: {opt init(#)}}initial value for the sample size or the difference
...
{synopt: {opt oratio}}odds ratio, {c -(}{it:p+1}(1-{it:p1+}){c )-}/{c -(}{it:p1+}(1-{it:p+1}){c )-}; may only be specified with marginal proportions{p_end}
{synoptline}
{p2colreset}{...}
...
the {manhelp power PSS} command using hypothesis tests.
...
{mansection PSS powerpairedproportionsRemarksandexamplessub1:{it:Alternative ways of specifying effect}} for details about the specification of this option.

{phang}
{opth sum(numlist)} is a synonym for {cmd:prdiscordant()}.  See
{mansection PSS powerpairedproportionsRemarksandexamplessub1:{it:Alternative ways of specifying effect}} for details about the specification of
this option.
...
{it:p+1}/{it:p1+}. See
{mansection PSS powerpairedproportionsRemarksandexamplessub1:{it:Alternative ways of specifying effect}} for details about the
...
Also see the {mansection pss powerpairedproportionsSyntaxcolumn:column} table in
{bf:[PSS] power pairedproportions} for a list of symbols used by the graphs.
...
{marker remarks}{...}
{title:Using power pairedproportions}
...
proportions; see
{mansection PSS powerpairedproportionsRemarksandexamplessub1:{it:Alternative ways of specifying effect}} for other
specifications.
...
{manhelp power PSS} for the descriptions of other options that control the
iteration procedure.
...
{synopt: {cmd: r(init)}}initial value for the sample size or the difference between discordant proportions{p_end}
