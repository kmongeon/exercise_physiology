{smcl}
{* *! version 1.0.6  14oct2016}{...}
{viewerdialog power "dialog power_onecorr"}{...}
{vieweralsosee "[PSS] power onecorrelation" "mansection PSS poweronecorrelation"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Remarks" "power_onecorrelation##remarks"}{...}
{viewerjumpto "Examples" "power_onecorrelation##examples"}{...}
{viewerjumpto "Stored results" "power_onecorrelation##stored_results"}{...}
{title:Title}

{p2colset 5 35 39 2}{...}
{p2col :{manlink PSS power onecorrelation} {hline 2}}Power analysis for a one-sample correlation test{p_end}
{p2colreset}{...}
...
{syntab:Iteration}
{synopt: {opt init(#)}}initial value for the sample size or correlation{p_end}
...
Also see the {mansection pss poweronecorrelationSyntaxcolumn:column} table in
{bf:[PSS] power onecorrelation} for a list of symbols used by the graphs.
...
{marker remarks}{...}
{title:Using power onecorrelation}
...
{synopt:{cmd: r(init)}}initial value for the sample size or the correlation{p_end}
