...
exist{p_end}
{synopt :{opt p:aram}{cmd:(4)}}estimate mean, period and treatment effects, and
...
See the 
{mansection R pkcrossRemarksandexamplestechnote:technical note} in
