...
{opt from(init_specs)} allows you to set the starting values of the model
   coefficients; see {manhelp maximize R} for a general discussion and
   syntax options.  
...
{phang2}{browse "http://www.youtube.com/watch?v=8xt4q7KHfBs":Time series, part 5: Introduction to ARMA/ARIMA models}
