...
{p2colset 5 22 24 2}{...}
{p2col :{manlink R hetprobit} {hline 2}}Heteroskedastic probit model{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:hetprob} is a synonym for {cmd:hetprobit}.
...
specifies the independent variables and the offset variable, if there is one,
...
{pstd}
The following option is available with {opt hetprobit} but is not shown in the
dialog box:
