*! version 1.1.4  21may2015
program define hetprobit, eclass byable(onecall) prop(ml_score svyb svyj svyr)
	version 13.0
	if _by() {
		local BY `"by `_byvars'`_byrc0':"'
	}
	`BY' _vce_parserun hetprobit, mark(CLuster) : `0'
	if "`s(exit)'" != "" {
...
*/				in ye _col(70) %9.2f e(chi2)
	...
	di in green "`txt' test of lnsigma2=0: " ///
