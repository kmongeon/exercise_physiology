...
{p2colset 5 24 26 2}{...}
{p2col :{manlink R heckoprobit} {hline 2}}Ordered probit model with sample selection{p_end}
{p2colreset}{...}
...
[{cmd:,} {opt nocon:stant} {opth off:set(varname:varname_o)}]{cmd:)}
[{it:options}]
...
{pstd}
The following option is available with {opt heckoprobit} but is not shown in the
dialog box:
